    ...
    (lambda (exp env)
       (cases expression exp
        ...
        ; #####################################################
         ...
         (call-exp (rator rand)
                   (call-nested-exp
                    (translation-of rator env) (translation-of rand env) 1))
         ...
         (letrec-exp (p-name var exp1 body)
                     (letrec-nested-exp p-name var 1 (translation-of exp1 env) (translation-of body env)))
